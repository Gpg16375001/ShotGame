		...
		LPARAM lParam )
{
	...
	switch ( message )
	{
		case WM_CREATE :
			...
			mciSendString( TEXT("open sound/start.wav alias SE_ST type waveaudio") , NULL , 0 , hWnd ) ;	// 開始直後
			mciSendString( TEXT("open sound/Boss.wav alias SE_END type waveaudio") , NULL , 0 , hWnd ) ;	// 終了
